        ...
        <main className="min-h-screen pt-32 pb-24 bg-background relative overflow-hidden">
            ...
            <article className="max-w-4xl mx-auto px-6 relative z-10">
                ...
                <header className="mb-12">
                    ...
                    <h1 className="font-display-lg text-4xl md:text-5xl lg:text-6xl text-white font-black uppercase tracking-tighter leading-tight mb-6 break-words">
                        {noticia.titulo}
                    </h1>
                    <p className="text-xl text-gray-400 font-medium leading-relaxed break-words">
                        {noticia.resumo}
                    </p>
                </header>
                ...
                <div className="text-gray-300 text-lg leading-relaxed space-y-6">
                    <p className="whitespace-pre-wrap break-words">{noticia.conteudo}</p>
                </div>
            </article>
        </main>
    );
